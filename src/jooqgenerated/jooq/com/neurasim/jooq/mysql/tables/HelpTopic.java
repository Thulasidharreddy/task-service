...
public class HelpTopic extends TableImpl<HelpTopicRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super UInteger, ? super String, ? super UShort, ? super String, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super UInteger, ? super String, ? super UShort, ? super String, ? super String, ? super String, ? extends U> from) {
