...
public class TimeZone extends TableImpl<TimeZoneRecord> {
     ...
     */
    public final TableField<TimeZoneRecord, TimeZoneUseLeapSeconds> USE_LEAP_SECONDS = createField(DSL.name("Use_leap_seconds"), SQLDataType.VARCHAR(1).nullable(false).defaultValue(DSL.inline("N", SQLDataType.VARCHAR)).asEnumDataType(com.neurasim.jooq.mysql.enums.TimeZoneUseLeapSeconds.class), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function2<? super UInteger, ? super TimeZoneUseLeapSeconds, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function2<? super UInteger, ? super TimeZoneUseLeapSeconds, ? extends U> from) {
