...
public class SlaveWorkerInfo implements Serializable {
    ...
    private final String checkpointRelayLogName;
    private final ULong checkpointRelayLogPos;
    private final String checkpointMasterLogName;
    private final ULong checkpointMasterLogPos;
    private final UInteger checkpointSeqno;
    private final UInteger checkpointGroupSize;
    private final byte[] checkpointGroupBitmap;
