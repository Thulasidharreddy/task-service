...
public class ServerCost extends TableImpl<ServerCostRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super String, ? super Double, ? super LocalDateTime, ? super String, ? super Double, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super String, ? super Double, ? super LocalDateTime, ? super String, ? super Double, ? extends U> from) {
