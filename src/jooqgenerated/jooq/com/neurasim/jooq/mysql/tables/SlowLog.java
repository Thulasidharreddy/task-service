...
import com.neurasim.jooq.mysql.tables.records.SlowLogRecord;
...
public class SlowLog extends TableImpl<SlowLogRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function12<? super LocalDateTime, ? super String, ? super LocalTime, ? super LocalTime, ? super Integer, ? super Integer, ? super String, ? super Integer, ? super Integer, ? super UInteger, ? super byte[], ? super ULong, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function12<? super LocalDateTime, ? super String, ? super LocalTime, ? super LocalTime, ? super Integer, ? super Integer, ? super String, ? super Integer, ? super Integer, ? super UInteger, ? super byte[], ? super ULong, ? extends U> from) {
