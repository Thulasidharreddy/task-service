...
public class NdbBinlogIndex implements Serializable {
    ...
    private final ULong epoch;
    private final UInteger inserts;
    private final UInteger updates;
    private final UInteger deletes;
    private final UInteger schemaops;
    private final UInteger origServerId;
    private final ULong origEpoch;
    private final UInteger gci;
    private final ULong nextPosition;
    private final String nextFile;
