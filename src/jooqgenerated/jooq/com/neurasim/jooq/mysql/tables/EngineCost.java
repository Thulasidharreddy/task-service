...
public class EngineCost extends TableImpl<EngineCostRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super String, ? super Integer, ? super String, ? super Double, ? super LocalDateTime, ? super String, ? super Double, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super String, ? super Integer, ? super String, ? super Double, ? super LocalDateTime, ? super String, ? super Double, ? extends U> from) {
