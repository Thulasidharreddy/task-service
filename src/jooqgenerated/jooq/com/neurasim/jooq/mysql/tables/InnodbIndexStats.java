...
public class InnodbIndexStats extends TableImpl<InnodbIndexStatsRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function8<? super String, ? super String, ? super String, ? super LocalDateTime, ? super String, ? super ULong, ? super ULong, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function8<? super String, ? super String, ? super String, ? super LocalDateTime, ? super String, ? super ULong, ? super ULong, ? super String, ? extends U> from) {
