...
public class TimeZoneTransitionType extends TableImpl<TimeZoneTransitionTypeRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super UInteger, ? super UInteger, ? super Integer, ? super UByte, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super UInteger, ? super UInteger, ? super Integer, ? super UByte, ? super String, ? extends U> from) {
