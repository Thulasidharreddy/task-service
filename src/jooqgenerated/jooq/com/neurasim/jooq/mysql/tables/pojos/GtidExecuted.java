...
public class GtidExecuted implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.intervalEnd == null) {
            ...
            return false;
        if (this.gtidTag == null) {
            if (other.gtidTag != null)
                return false;
        }
        else if (!this.gtidTag.equals(other.gtidTag))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.gtidTag == null) ? 0 : this.gtidTag.hashCode());
        return result;
    }
