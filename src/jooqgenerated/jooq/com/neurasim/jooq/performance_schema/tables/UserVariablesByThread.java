...
public class UserVariablesByThread extends TableImpl<UserVariablesByThreadRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function3<? super ULong, ? super String, ? super byte[], ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function3<? super ULong, ? super String, ? super byte[], ? extends U> from) {
