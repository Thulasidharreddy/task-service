...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, ULong> MAX_SESSION_CONTROLLED_MEMORY = createField(DSL.name("MAX_SESSION_CONTROLLED_MEMORY"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.users.MAX_SESSION_TOTAL_MEMORY</code>.
     */
    public final TableField<UsersRecord, ULong> MAX_SESSION_TOTAL_MEMORY = createField(DSL.name("MAX_SESSION_TOTAL_MEMORY"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
