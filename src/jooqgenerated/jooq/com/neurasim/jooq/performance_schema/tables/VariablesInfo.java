...
import com.neurasim.jooq.performance_schema.tables.records.VariablesInfoRecord;
...
public class VariablesInfo extends TableImpl<VariablesInfoRecord> {
     ...
     */
    public final TableField<VariablesInfoRecord, VariablesInfoVariableSource> VARIABLE_SOURCE = createField(DSL.name("VARIABLE_SOURCE"), SQLDataType.VARCHAR(12).defaultValue(DSL.inline("COMPILED", SQLDataType.VARCHAR)).asEnumDataType(com.neurasim.jooq.performance_schema.enums.VariablesInfoVariableSource.class), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function8<? super String, ? super VariablesInfoVariableSource, ? super String, ? super String, ? super String, ? super LocalDateTime, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function8<? super String, ? super VariablesInfoVariableSource, ? super String, ? super String, ? super String, ? super LocalDateTime, ? super String, ? super String, ? extends U> from) {
