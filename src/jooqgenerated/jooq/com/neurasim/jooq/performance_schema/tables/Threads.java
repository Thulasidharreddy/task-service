...
public class Threads extends TableImpl<ThreadsRecord> {
     ...
     */
    public final TableField<ThreadsRecord, ThreadsInstrumented> INSTRUMENTED = createField(DSL.name("INSTRUMENTED"), SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.neurasim.jooq.performance_schema.enums.ThreadsInstrumented.class), this, "");

    /**
     * The column <code>performance_schema.threads.HISTORY</code>.
     */
    public final TableField<ThreadsRecord, ThreadsHistory> HISTORY = createField(DSL.name("HISTORY"), SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.neurasim.jooq.performance_schema.enums.ThreadsHistory.class), this, "");
     ...
     */
    public final TableField<ThreadsRecord, ThreadsExecutionEngine> EXECUTION_ENGINE = createField(DSL.name("EXECUTION_ENGINE"), SQLDataType.VARCHAR(9).asEnumDataType(com.neurasim.jooq.performance_schema.enums.ThreadsExecutionEngine.class), this, "");

    /**
     * The column <code>performance_schema.threads.CONTROLLED_MEMORY</code>.
     */
    public final TableField<ThreadsRecord, ULong> CONTROLLED_MEMORY = createField(DSL.name("CONTROLLED_MEMORY"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.threads.MAX_CONTROLLED_MEMORY</code>.
     */
    public final TableField<ThreadsRecord, ULong> MAX_CONTROLLED_MEMORY = createField(DSL.name("MAX_CONTROLLED_MEMORY"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.threads.TOTAL_MEMORY</code>.
     */
    public final TableField<ThreadsRecord, ULong> TOTAL_MEMORY = createField(DSL.name("TOTAL_MEMORY"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.threads.MAX_TOTAL_MEMORY</code>.
     */
    public final TableField<ThreadsRecord, ULong> MAX_TOTAL_MEMORY = createField(DSL.name("MAX_TOTAL_MEMORY"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.threads.TELEMETRY_ACTIVE</code>.
     */
    public final TableField<ThreadsRecord, ThreadsTelemetryActive> TELEMETRY_ACTIVE = createField(DSL.name("TELEMETRY_ACTIVE"), SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.neurasim.jooq.performance_schema.enums.ThreadsTelemetryActive.class), this, "");
