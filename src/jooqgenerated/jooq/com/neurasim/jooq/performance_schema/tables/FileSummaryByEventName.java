...
public class FileSummaryByEventName extends TableImpl<FileSummaryByEventNameRecord> {
    ...
    @Override
    public FileSummaryByEventName as(Table<?> alias) {
        return new FileSummaryByEventName(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public FileSummaryByEventName rename(Table<?> name) {
        return new FileSummaryByEventName(name.getQualifiedName(), null);
    }
}
