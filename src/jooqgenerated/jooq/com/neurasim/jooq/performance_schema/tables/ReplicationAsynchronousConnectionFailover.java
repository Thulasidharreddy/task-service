...
import com.neurasim.jooq.performance_schema.tables.records.ReplicationAsynchronousConnectionFailoverRecord;
...
public class ReplicationAsynchronousConnectionFailover extends TableImpl<ReplicationAsynchronousConnectionFailoverRecord> {
     ...
     */
    public final TableField<ReplicationAsynchronousConnectionFailoverRecord, String> NETWORK_NAMESPACE = createField(DSL.name("NETWORK_NAMESPACE"), SQLDataType.CHAR(64), this, "The source network namespace that the replica will attempt to switch over the replication connection to in case of a failure. If its value is empty, connections use the default (global) namespace.");
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super String, ? super String, ? super Integer, ? super String, ? super UInteger, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super String, ? super String, ? super Integer, ? super String, ? super UInteger, ? super String, ? extends U> from) {
