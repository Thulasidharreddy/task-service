...
public class EventsTransactionsSummaryByUserByEventName implements Serializable {
    ...
    public EventsTransactionsSummaryByUserByEventName(EventsTransactionsSummaryByUserByEventName value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final EventsTransactionsSummaryByUserByEventName other = (EventsTransactionsSummaryByUserByEventName) obj;
        if (this.user == null) {
            if (other.user != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("EventsTransactionsSummaryByUserByEventName (");
