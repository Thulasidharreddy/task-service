...
public class EventsStatementsHistogramByDigestRecord extends TableRecordImpl<EventsStatementsHistogramByDigestRecord> implements Record8<String, String, UInteger, ULong, ULong, ULong, ULong, Double> {
     ...
     */
    public EventsStatementsHistogramByDigestRecord setSchemaName(String value) {
        set(0, value);
        return this;
    }
     ...
     */
    public EventsStatementsHistogramByDigestRecord setDigest(String value) {
        set(1, value);
        return this;
    }
     ...
     */
    public EventsStatementsHistogramByDigestRecord setBucketNumber(UInteger value) {
        set(2, value);
        return this;
    }
     ...
     */
    public EventsStatementsHistogramByDigestRecord setBucketTimerLow(ULong value) {
        set(3, value);
        return this;
    }
     ...
     */
    public EventsStatementsHistogramByDigestRecord setBucketTimerHigh(ULong value) {
        set(4, value);
        return this;
    }
     ...
     */
    public EventsStatementsHistogramByDigestRecord setCountBucket(ULong value) {
        set(5, value);
        return this;
    }
     ...
     */
    public EventsStatementsHistogramByDigestRecord setCountBucketAndLower(ULong value) {
        set(6, value);
        return this;
    }
     ...
     */
    public EventsStatementsHistogramByDigestRecord setBucketQuantile(Double value) {
        set(7, value);
        return this;
    }
     ...
     * Create a detached, initialised EventsStatementsHistogramByDigestRecord
     */
    public EventsStatementsHistogramByDigestRecord(com.neurasim.jooq.performance_schema.tables.pojos.EventsStatementsHistogramByDigest value) {
        super(EventsStatementsHistogramByDigest.EVENTS_STATEMENTS_HISTOGRAM_BY_DIGEST);

        if (value != null) {
            setSchemaName(value.getSchemaName());
            setDigest(value.getDigest());
            setBucketNumber(value.getBucketNumber());
            setBucketTimerLow(value.getBucketTimerLow());
            setBucketTimerHigh(value.getBucketTimerHigh());
            setCountBucket(value.getCountBucket());
            setCountBucketAndLower(value.getCountBucketAndLower());
            setBucketQuantile(value.getBucketQuantile());
        }
    }
}
