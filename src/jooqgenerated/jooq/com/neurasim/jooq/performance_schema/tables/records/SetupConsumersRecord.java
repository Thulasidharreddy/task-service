...
public class SetupConsumersRecord extends UpdatableRecordImpl<SetupConsumersRecord> implements Record2<String, SetupConsumersEnabled> {
     ...
     */
    public SetupConsumersRecord setName(String value) {
        set(0, value);
        return this;
    }
     ...
     */
    public SetupConsumersRecord setEnabled(SetupConsumersEnabled value) {
        set(1, value);
        return this;
    }
     ...
     * Create a detached, initialised SetupConsumersRecord
     */
    public SetupConsumersRecord(com.neurasim.jooq.performance_schema.tables.pojos.SetupConsumers value) {
        super(SetupConsumers.SETUP_CONSUMERS);
