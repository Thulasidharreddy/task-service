...
public class ReplicationApplierFiltersRecord extends TableRecordImpl<ReplicationApplierFiltersRecord> implements Record6<String, String, String, ReplicationApplierFiltersConfiguredBy, LocalDateTime, ULong> {
     ...
     */
    public ReplicationApplierFiltersRecord setChannelName(String value) {
        set(0, value);
        return this;
    }
     ...
     */
    public ReplicationApplierFiltersRecord setFilterName(String value) {
        set(1, value);
        return this;
    }
     ...
     */
    public ReplicationApplierFiltersRecord setFilterRule(String value) {
        set(2, value);
        return this;
    }
     ...
     */
    public ReplicationApplierFiltersRecord setConfiguredBy(ReplicationApplierFiltersConfiguredBy value) {
        set(3, value);
        return this;
    }
     ...
     */
    public ReplicationApplierFiltersRecord setActiveSince(LocalDateTime value) {
        set(4, value);
        return this;
    }
     ...
     */
    public ReplicationApplierFiltersRecord setCounter(ULong value) {
        set(5, value);
        return this;
    }
     ...
     * Create a detached, initialised ReplicationApplierFiltersRecord
     */
    public ReplicationApplierFiltersRecord(com.neurasim.jooq.performance_schema.tables.pojos.ReplicationApplierFilters value) {
        super(ReplicationApplierFilters.REPLICATION_APPLIER_FILTERS);

        if (value != null) {
            setChannelName(value.getChannelName());
            setFilterName(value.getFilterName());
            setFilterRule(value.getFilterRule());
            setConfiguredBy(value.getConfiguredBy());
            setActiveSince(value.getActiveSince());
