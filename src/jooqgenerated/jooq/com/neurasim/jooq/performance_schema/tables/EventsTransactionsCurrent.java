...
public class EventsTransactionsCurrent extends TableImpl<EventsTransactionsCurrentRecord> {
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentState> STATE = createField(DSL.name("STATE"), SQLDataType.VARCHAR(11).asEnumDataType(com.neurasim.jooq.performance_schema.enums.EventsTransactionsCurrentState.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, String> GTID = createField(DSL.name("GTID"), SQLDataType.VARCHAR(90), this, "");
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentAccessMode> ACCESS_MODE = createField(DSL.name("ACCESS_MODE"), SQLDataType.VARCHAR(10).asEnumDataType(com.neurasim.jooq.performance_schema.enums.EventsTransactionsCurrentAccessMode.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentAutocommit> AUTOCOMMIT = createField(DSL.name("AUTOCOMMIT"), SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.neurasim.jooq.performance_schema.enums.EventsTransactionsCurrentAutocommit.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentNestingEventType> NESTING_EVENT_TYPE = createField(DSL.name("NESTING_EVENT_TYPE"), SQLDataType.VARCHAR(11).asEnumDataType(com.neurasim.jooq.performance_schema.enums.EventsTransactionsCurrentNestingEventType.class), this, "");
