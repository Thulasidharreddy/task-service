...
public class FileInstancesRecord extends UpdatableRecordImpl<FileInstancesRecord> implements Record3<String, String, UInteger> {
     ...
     */
    public FileInstancesRecord setFileName(String value) {
        set(0, value);
        return this;
    }
     ...
     */
    public FileInstancesRecord setEventName(String value) {
        set(1, value);
        return this;
    }
     ...
     */
    public FileInstancesRecord setOpenCount(UInteger value) {
        set(2, value);
        return this;
    }
     ...
     * Create a detached, initialised FileInstancesRecord
     */
    public FileInstancesRecord(com.neurasim.jooq.performance_schema.tables.pojos.FileInstances value) {
        super(FileInstances.FILE_INSTANCES);

        if (value != null) {
            setFileName(value.getFileName());
            setEventName(value.getEventName());
            setOpenCount(value.getOpenCount());
        }
    }
}
