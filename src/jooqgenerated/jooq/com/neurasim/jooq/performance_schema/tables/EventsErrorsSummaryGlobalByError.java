...
public class EventsErrorsSummaryGlobalByError extends TableImpl<EventsErrorsSummaryGlobalByErrorRecord> {
     ...
     */
    public final TableField<EventsErrorsSummaryGlobalByErrorRecord, LocalDateTime> FIRST_SEEN = createField(DSL.name("FIRST_SEEN"), SQLDataType.LOCALDATETIME(0), this, "");

    /**
     * The column
     * <code>performance_schema.events_errors_summary_global_by_error.LAST_SEEN</code>.
     */
    public final TableField<EventsErrorsSummaryGlobalByErrorRecord, LocalDateTime> LAST_SEEN = createField(DSL.name("LAST_SEEN"), SQLDataType.LOCALDATETIME(0), this, "");
    ...
    @Override
    public List<UniqueKey<EventsErrorsSummaryGlobalByErrorRecord>> getUniqueKeys() {
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super Integer, ? super String, ? super String, ? super ULong, ? super ULong, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super Integer, ? super String, ? super String, ? super ULong, ? super ULong, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
