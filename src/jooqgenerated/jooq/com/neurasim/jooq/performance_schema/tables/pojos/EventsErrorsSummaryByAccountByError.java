...
public class EventsErrorsSummaryByAccountByError implements Serializable {
    ...
    public EventsErrorsSummaryByAccountByError(EventsErrorsSummaryByAccountByError value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final EventsErrorsSummaryByAccountByError other = (EventsErrorsSummaryByAccountByError) obj;
        if (this.user == null) {
            if (other.user != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("EventsErrorsSummaryByAccountByError (");
