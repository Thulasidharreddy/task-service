...
public class EventsStagesSummaryByUserByEventName implements Serializable {
    ...
    public EventsStagesSummaryByUserByEventName(EventsStagesSummaryByUserByEventName value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final EventsStagesSummaryByUserByEventName other = (EventsStagesSummaryByUserByEventName) obj;
        if (this.user == null) {
            if (other.user != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("EventsStagesSummaryByUserByEventName (");
