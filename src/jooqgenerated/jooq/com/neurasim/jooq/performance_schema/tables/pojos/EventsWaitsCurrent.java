...
public class EventsWaitsCurrent implements Serializable {
    ...
    private final EventsWaitsCurrentNestingEventType nestingEventType;
    private final String operation;
    private final Long numberOfBytes;
    private final UInteger flags;

    public EventsWaitsCurrent(EventsWaitsCurrent value) {
    ...
    public EventsWaitsCurrent(
        ...
        EventsWaitsCurrentNestingEventType nestingEventType,
        String operation,
        Long numberOfBytes,
        UInteger flags
    ) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final EventsWaitsCurrent other = (EventsWaitsCurrent) obj;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("EventsWaitsCurrent (");
