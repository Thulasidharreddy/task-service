...
public class MemorySummaryByUserByEventName implements Serializable {
    ...
    public MemorySummaryByUserByEventName(MemorySummaryByUserByEventName value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final MemorySummaryByUserByEventName other = (MemorySummaryByUserByEventName) obj;
        if (this.user == null) {
            if (other.user != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("MemorySummaryByUserByEventName (");
