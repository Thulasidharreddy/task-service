...
public class SetupObjects extends TableImpl<SetupObjectsRecord> {
     ...
     */
    public final TableField<SetupObjectsRecord, SetupObjectsObjectType> OBJECT_TYPE = createField(DSL.name("OBJECT_TYPE"), SQLDataType.VARCHAR(9).nullable(false).defaultValue(DSL.inline("TABLE", SQLDataType.VARCHAR)).asEnumDataType(com.neurasim.jooq.performance_schema.enums.SetupObjectsObjectType.class), this, "");
     ...
     */
    public final TableField<SetupObjectsRecord, SetupObjectsEnabled> ENABLED = createField(DSL.name("ENABLED"), SQLDataType.VARCHAR(3).nullable(false).defaultValue(DSL.inline("YES", SQLDataType.VARCHAR)).asEnumDataType(com.neurasim.jooq.performance_schema.enums.SetupObjectsEnabled.class), this, "");

    /**
     * The column <code>performance_schema.setup_objects.TIMED</code>.
     */
    public final TableField<SetupObjectsRecord, SetupObjectsTimed> TIMED = createField(DSL.name("TIMED"), SQLDataType.VARCHAR(3).nullable(false).defaultValue(DSL.inline("YES", SQLDataType.VARCHAR)).asEnumDataType(com.neurasim.jooq.performance_schema.enums.SetupObjectsTimed.class), this, "");
    ...
    @Override
    public List<UniqueKey<SetupObjectsRecord>> getUniqueKeys() {
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super SetupObjectsObjectType, ? super String, ? super String, ? super SetupObjectsEnabled, ? super SetupObjectsTimed, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super SetupObjectsObjectType, ? super String, ? super String, ? super SetupObjectsEnabled, ? super SetupObjectsTimed, ? extends U> from) {
