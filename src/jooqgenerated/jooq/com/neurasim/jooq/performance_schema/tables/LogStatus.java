...
import com.neurasim.jooq.performance_schema.tables.records.LogStatusRecord;
...
public class LogStatus extends TableImpl<LogStatusRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super String, ? super JSON, ? super JSON, ? super JSON, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function4<? super String, ? super JSON, ? super JSON, ? super JSON, ? extends U> from) {
