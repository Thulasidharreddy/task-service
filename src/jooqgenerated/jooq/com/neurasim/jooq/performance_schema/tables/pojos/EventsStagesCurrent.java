...
public class EventsStagesCurrent implements Serializable {
    ...
    private final EventsStagesCurrentNestingEventType nestingEventType;

    public EventsStagesCurrent(EventsStagesCurrent value) {
    ...
    public EventsStagesCurrent(
        ...
        EventsStagesCurrentNestingEventType nestingEventType
    ) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final EventsStagesCurrent other = (EventsStagesCurrent) obj;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("EventsStagesCurrent (");
