...
public class EventsStatementsSummaryByProgram implements Serializable {
    ...
    private final EventsStatementsSummaryByProgramObjectType objectType;
    ...
    private final ULong countStatements;
    private final ULong sumStatementsWait;
    private final ULong minStatementsWait;
    private final ULong avgStatementsWait;
    private final ULong maxStatementsWait;
    ...
    public EventsStatementsSummaryByProgram(EventsStatementsSummaryByProgram value) {
        ...
        this.countStatements = value.countStatements;
        this.sumStatementsWait = value.sumStatementsWait;
        this.minStatementsWait = value.minStatementsWait;
        this.avgStatementsWait = value.avgStatementsWait;
        this.maxStatementsWait = value.maxStatementsWait;
    ...
    public EventsStatementsSummaryByProgram(
        EventsStatementsSummaryByProgramObjectType objectType,
        String objectSchema,
        String objectName,
        ULong countStar,
        ULong sumTimerWait,
        ...
        ULong avgTimerWait,
        ULong maxTimerWait,
        ULong countStatements,
        ULong sumStatementsWait,
        ULong minStatementsWait,
        ULong avgStatementsWait,
        ULong maxStatementsWait,
        ULong sumLockTime,
        ULong sumErrors,
        ULong sumWarnings,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final EventsStatementsSummaryByProgram other = (EventsStatementsSummaryByProgram) obj;
        ...
        if (this.maxTimerWait == null) {
            ...
            return false;
        if (this.countStatements == null) {
            if (other.countStatements != null)
                return false;
        }
        else if (!this.countStatements.equals(other.countStatements))
            return false;
        if (this.sumStatementsWait == null) {
            if (other.sumStatementsWait != null)
                return false;
        }
        else if (!this.sumStatementsWait.equals(other.sumStatementsWait))
            return false;
        if (this.minStatementsWait == null) {
            if (other.minStatementsWait != null)
                return false;
        }
        else if (!this.minStatementsWait.equals(other.minStatementsWait))
            return false;
        if (this.avgStatementsWait == null) {
            if (other.avgStatementsWait != null)
                return false;
        }
        else if (!this.avgStatementsWait.equals(other.avgStatementsWait))
            return false;
        if (this.maxStatementsWait == null) {
            if (other.maxStatementsWait != null)
                return false;
        }
        else if (!this.maxStatementsWait.equals(other.maxStatementsWait))
            return false;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.countStatements == null) ? 0 : this.countStatements.hashCode());
        result = prime * result + ((this.sumStatementsWait == null) ? 0 : this.sumStatementsWait.hashCode());
        result = prime * result + ((this.minStatementsWait == null) ? 0 : this.minStatementsWait.hashCode());
        result = prime * result + ((this.avgStatementsWait == null) ? 0 : this.avgStatementsWait.hashCode());
        result = prime * result + ((this.maxStatementsWait == null) ? 0 : this.maxStatementsWait.hashCode());
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("EventsStatementsSummaryByProgram (");
        ...
        sb.append(", ").append(countStatements);
        sb.append(", ").append(sumStatementsWait);
        sb.append(", ").append(minStatementsWait);
        sb.append(", ").append(avgStatementsWait);
        sb.append(", ").append(maxStatementsWait);
