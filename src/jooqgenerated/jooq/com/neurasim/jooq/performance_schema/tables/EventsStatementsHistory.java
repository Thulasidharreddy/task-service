...
public class EventsStatementsHistory extends TableImpl<EventsStatementsHistoryRecord> {
     ...
     */
    public final TableField<EventsStatementsHistoryRecord, EventsStatementsHistoryNestingEventType> NESTING_EVENT_TYPE = createField(DSL.name("NESTING_EVENT_TYPE"), SQLDataType.VARCHAR(11).asEnumDataType(com.neurasim.jooq.performance_schema.enums.EventsStatementsHistoryNestingEventType.class), this, "");
     ...
     */
    public final TableField<EventsStatementsHistoryRecord, ULong> CPU_TIME = createField(DSL.name("CPU_TIME"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_history.MAX_CONTROLLED_MEMORY</code>.
     */
    public final TableField<EventsStatementsHistoryRecord, ULong> MAX_CONTROLLED_MEMORY = createField(DSL.name("MAX_CONTROLLED_MEMORY"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_history.MAX_TOTAL_MEMORY</code>.
     */
    public final TableField<EventsStatementsHistoryRecord, ULong> MAX_TOTAL_MEMORY = createField(DSL.name("MAX_TOTAL_MEMORY"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_history.EXECUTION_ENGINE</code>.
     */
    public final TableField<EventsStatementsHistoryRecord, EventsStatementsHistoryExecutionEngine> EXECUTION_ENGINE = createField(DSL.name("EXECUTION_ENGINE"), SQLDataType.VARCHAR(9).asEnumDataType(com.neurasim.jooq.performance_schema.enums.EventsStatementsHistoryExecutionEngine.class), this, "");
