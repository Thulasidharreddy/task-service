...
public class EventsStatementsSummaryByThreadByEventName extends TableImpl<EventsStatementsSummaryByThreadByEventNameRecord> {
     ...
     */
    public final TableField<EventsStatementsSummaryByThreadByEventNameRecord, ULong> SUM_CPU_TIME = createField(DSL.name("SUM_CPU_TIME"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_summary_by_thread_by_event_name.MAX_CONTROLLED_MEMORY</code>.
     */
    public final TableField<EventsStatementsSummaryByThreadByEventNameRecord, ULong> MAX_CONTROLLED_MEMORY = createField(DSL.name("MAX_CONTROLLED_MEMORY"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_summary_by_thread_by_event_name.MAX_TOTAL_MEMORY</code>.
     */
    public final TableField<EventsStatementsSummaryByThreadByEventNameRecord, ULong> MAX_TOTAL_MEMORY = createField(DSL.name("MAX_TOTAL_MEMORY"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_summary_by_thread_by_event_name.COUNT_SECONDARY</code>.
     */
    public final TableField<EventsStatementsSummaryByThreadByEventNameRecord, ULong> COUNT_SECONDARY = createField(DSL.name("COUNT_SECONDARY"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
    ...
    @Override
    public EventsStatementsSummaryByThreadByEventName as(Table<?> alias) {
        return new EventsStatementsSummaryByThreadByEventName(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public EventsStatementsSummaryByThreadByEventName rename(Table<?> name) {
        return new EventsStatementsSummaryByThreadByEventName(name.getQualifiedName(), null);
    }
}
