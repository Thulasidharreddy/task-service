...
public class EventsTransactionsSummaryByHostByEventName implements Serializable {
    ...
    public EventsTransactionsSummaryByHostByEventName(EventsTransactionsSummaryByHostByEventName value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final EventsTransactionsSummaryByHostByEventName other = (EventsTransactionsSummaryByHostByEventName) obj;
        if (this.host == null) {
            if (other.host != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("EventsTransactionsSummaryByHostByEventName (");
