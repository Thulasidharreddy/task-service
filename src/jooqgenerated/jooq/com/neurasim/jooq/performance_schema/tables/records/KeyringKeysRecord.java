...
public class KeyringKeysRecord extends TableRecordImpl<KeyringKeysRecord> implements Record3<String, String, String> {
     ...
     */
    public KeyringKeysRecord setKeyId(String value) {
        set(0, value);
        return this;
    }
     ...
     */
    public KeyringKeysRecord setKeyOwner(String value) {
        set(1, value);
        return this;
    }
     ...
     */
    public KeyringKeysRecord setBackendKeyId(String value) {
        set(2, value);
        return this;
    }
     ...
     * Create a detached, initialised KeyringKeysRecord
     */
    public KeyringKeysRecord(com.neurasim.jooq.performance_schema.tables.pojos.KeyringKeys value) {
        super(KeyringKeys.KEYRING_KEYS);

        if (value != null) {
            setKeyId(value.getKeyId());
            setKeyOwner(value.getKeyOwner());
            setBackendKeyId(value.getBackendKeyId());
        }
    }
}
