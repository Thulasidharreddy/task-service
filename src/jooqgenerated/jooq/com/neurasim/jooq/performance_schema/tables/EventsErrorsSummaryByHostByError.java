...
public class EventsErrorsSummaryByHostByError extends TableImpl<EventsErrorsSummaryByHostByErrorRecord> {
     ...
     */
    public final TableField<EventsErrorsSummaryByHostByErrorRecord, LocalDateTime> FIRST_SEEN = createField(DSL.name("FIRST_SEEN"), SQLDataType.LOCALDATETIME(0), this, "");

    /**
     * The column
     * <code>performance_schema.events_errors_summary_by_host_by_error.LAST_SEEN</code>.
     */
    public final TableField<EventsErrorsSummaryByHostByErrorRecord, LocalDateTime> LAST_SEEN = createField(DSL.name("LAST_SEEN"), SQLDataType.LOCALDATETIME(0), this, "");
    ...
    @Override
    public List<UniqueKey<EventsErrorsSummaryByHostByErrorRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_EVENTS_ERRORS_SUMMARY_BY_HOST_BY_ERROR_HOST);
    }
    ...
    @Override
    public EventsErrorsSummaryByHostByError as(Table<?> alias) {
        return new EventsErrorsSummaryByHostByError(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public EventsErrorsSummaryByHostByError rename(Table<?> name) {
        return new EventsErrorsSummaryByHostByError(name.getQualifiedName(), null);
    }
