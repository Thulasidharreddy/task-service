...
public class VariablesByThread extends TableImpl<VariablesByThreadRecord> {
    ...
    @Override
    public VariablesByThread as(Table<?> alias) {
        return new VariablesByThread(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public VariablesByThread rename(Table<?> name) {
        return new VariablesByThread(name.getQualifiedName(), null);
    }
