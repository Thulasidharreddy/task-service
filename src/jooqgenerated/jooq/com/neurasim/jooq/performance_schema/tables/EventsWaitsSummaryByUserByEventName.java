...
public class EventsWaitsSummaryByUserByEventName extends TableImpl<EventsWaitsSummaryByUserByEventNameRecord> {
    ...
    @Override
    public List<UniqueKey<EventsWaitsSummaryByUserByEventNameRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_EVENTS_WAITS_SUMMARY_BY_USER_BY_EVENT_NAME_USER);
    }
    ...
    @Override
    public EventsWaitsSummaryByUserByEventName as(Table<?> alias) {
        return new EventsWaitsSummaryByUserByEventName(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public EventsWaitsSummaryByUserByEventName rename(Table<?> name) {
        return new EventsWaitsSummaryByUserByEventName(name.getQualifiedName(), null);
    }
