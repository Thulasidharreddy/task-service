...
public class SetupActors extends TableImpl<SetupActorsRecord> {
     ...
     */
    public final TableField<SetupActorsRecord, SetupActorsEnabled> ENABLED = createField(DSL.name("ENABLED"), SQLDataType.VARCHAR(3).nullable(false).defaultValue(DSL.inline("YES", SQLDataType.VARCHAR)).asEnumDataType(com.neurasim.jooq.performance_schema.enums.SetupActorsEnabled.class), this, "");

    /**
     * The column <code>performance_schema.setup_actors.HISTORY</code>.
     */
    public final TableField<SetupActorsRecord, SetupActorsHistory> HISTORY = createField(DSL.name("HISTORY"), SQLDataType.VARCHAR(3).nullable(false).defaultValue(DSL.inline("YES", SQLDataType.VARCHAR)).asEnumDataType(com.neurasim.jooq.performance_schema.enums.SetupActorsHistory.class), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super String, ? super String, ? super String, ? super SetupActorsEnabled, ? super SetupActorsHistory, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super String, ? super String, ? super String, ? super SetupActorsEnabled, ? super SetupActorsHistory, ? extends U> from) {
