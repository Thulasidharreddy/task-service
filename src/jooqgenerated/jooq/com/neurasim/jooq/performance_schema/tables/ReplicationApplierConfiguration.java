...
public class ReplicationApplierConfiguration extends TableImpl<ReplicationApplierConfigurationRecord> {
     ...
     */
    public final TableField<ReplicationApplierConfigurationRecord, ReplicationApplierConfigurationRequireRowFormat> REQUIRE_ROW_FORMAT = createField(DSL.name("REQUIRE_ROW_FORMAT"), SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.neurasim.jooq.performance_schema.enums.ReplicationApplierConfigurationRequireRowFormat.class), this, "Indicates whether the channel shall only accept row based events.");
     ...
     */
    public final TableField<ReplicationApplierConfigurationRecord, ReplicationApplierConfigurationRequireTablePrimaryKeyCheck> REQUIRE_TABLE_PRIMARY_KEY_CHECK = createField(DSL.name("REQUIRE_TABLE_PRIMARY_KEY_CHECK"), SQLDataType.VARCHAR(8).nullable(false).asEnumDataType(com.neurasim.jooq.performance_schema.enums.ReplicationApplierConfigurationRequireTablePrimaryKeyCheck.class), this, "Indicates what is the channel policy regarding tables without primary keys on create and alter table queries");
     ...
     */
    public final TableField<ReplicationApplierConfigurationRecord, ReplicationApplierConfigurationAssignGtidsToAnonymousTransactionsType> ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_TYPE = createField(DSL.name("ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_TYPE"), SQLDataType.VARCHAR(5).nullable(false).asEnumDataType(com.neurasim.jooq.performance_schema.enums.ReplicationApplierConfigurationAssignGtidsToAnonymousTransactionsType.class), this, "Indicates whether the channel will generate a new GTID for anonymous transactions. OFF means that anonymous transactions will remain anonymous. LOCAL means that anonymous transactions will be assigned a newly generated GTID based on server_uuid. UUID indicates that anonymous transactions will be assigned a newly generated GTID based on Assign_gtids_to_anonymous_transactions_value");
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super String, ? super Integer, ? super String, ? super ReplicationApplierConfigurationRequireRowFormat, ? super ReplicationApplierConfigurationRequireTablePrimaryKeyCheck, ? super ReplicationApplierConfigurationAssignGtidsToAnonymousTransactionsType, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super String, ? super Integer, ? super String, ? super ReplicationApplierConfigurationRequireRowFormat, ? super ReplicationApplierConfigurationRequireTablePrimaryKeyCheck, ? super ReplicationApplierConfigurationAssignGtidsToAnonymousTransactionsType, ? super String, ? extends U> from) {
