...
import com.neurasim.jooq.performance_schema.tables.records.ReplicationGroupMemberStatsRecord;
...
public class ReplicationGroupMemberStats extends TableImpl<ReplicationGroupMemberStatsRecord> {
    ...
    @Override
    public ReplicationGroupMemberStats as(Table<?> alias) {
        return new ReplicationGroupMemberStats(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ReplicationGroupMemberStats rename(Table<?> name) {
        return new ReplicationGroupMemberStats(name.getQualifiedName(), null);
    }
     ...
     */
    public <U> SelectField<U> mapping(Function13<? super String, ? super String, ? super String, ? super ULong, ? super ULong, ? super ULong, ? super ULong, ? super String, ? super String, ? super ULong, ? super ULong, ? super ULong, ? super ULong, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function13<? super String, ? super String, ? super String, ? super ULong, ? super ULong, ? super ULong, ? super ULong, ? super String, ? super String, ? super ULong, ? super ULong, ? super ULong, ? super ULong, ? extends U> from) {
