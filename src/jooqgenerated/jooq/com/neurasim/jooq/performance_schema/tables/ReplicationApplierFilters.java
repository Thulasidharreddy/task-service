...
import com.neurasim.jooq.performance_schema.tables.records.ReplicationApplierFiltersRecord;
...
public class ReplicationApplierFilters extends TableImpl<ReplicationApplierFiltersRecord> {
     ...
     */
    public final TableField<ReplicationApplierFiltersRecord, ReplicationApplierFiltersConfiguredBy> CONFIGURED_BY = createField(DSL.name("CONFIGURED_BY"), SQLDataType.VARCHAR(37).nullable(false).asEnumDataType(com.neurasim.jooq.performance_schema.enums.ReplicationApplierFiltersConfiguredBy.class), this, "");

    /**
     * The column
     * <code>performance_schema.replication_applier_filters.ACTIVE_SINCE</code>.
     */
    public final TableField<ReplicationApplierFiltersRecord, LocalDateTime> ACTIVE_SINCE = createField(DSL.name("ACTIVE_SINCE"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super String, ? super String, ? super String, ? super ReplicationApplierFiltersConfiguredBy, ? super LocalDateTime, ? super ULong, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super String, ? super String, ? super String, ? super ReplicationApplierFiltersConfiguredBy, ? super LocalDateTime, ? super ULong, ? extends U> from) {
