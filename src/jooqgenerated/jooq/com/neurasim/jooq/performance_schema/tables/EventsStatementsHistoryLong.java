...
import com.neurasim.jooq.performance_schema.tables.records.EventsStatementsHistoryLongRecord;
...
public class EventsStatementsHistoryLong extends TableImpl<EventsStatementsHistoryLongRecord> {
     ...
     */
    public final TableField<EventsStatementsHistoryLongRecord, EventsStatementsHistoryLongNestingEventType> NESTING_EVENT_TYPE = createField(DSL.name("NESTING_EVENT_TYPE"), SQLDataType.VARCHAR(11).asEnumDataType(com.neurasim.jooq.performance_schema.enums.EventsStatementsHistoryLongNestingEventType.class), this, "");
     ...
     */
    public final TableField<EventsStatementsHistoryLongRecord, ULong> CPU_TIME = createField(DSL.name("CPU_TIME"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_history_long.MAX_CONTROLLED_MEMORY</code>.
     */
    public final TableField<EventsStatementsHistoryLongRecord, ULong> MAX_CONTROLLED_MEMORY = createField(DSL.name("MAX_CONTROLLED_MEMORY"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_history_long.MAX_TOTAL_MEMORY</code>.
     */
    public final TableField<EventsStatementsHistoryLongRecord, ULong> MAX_TOTAL_MEMORY = createField(DSL.name("MAX_TOTAL_MEMORY"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column
     * <code>performance_schema.events_statements_history_long.EXECUTION_ENGINE</code>.
     */
    public final TableField<EventsStatementsHistoryLongRecord, EventsStatementsHistoryLongExecutionEngine> EXECUTION_ENGINE = createField(DSL.name("EXECUTION_ENGINE"), SQLDataType.VARCHAR(9).asEnumDataType(com.neurasim.jooq.performance_schema.enums.EventsStatementsHistoryLongExecutionEngine.class), this, "");
