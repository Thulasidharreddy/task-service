...
public class EventsErrorsSummaryByHostByError implements Serializable {
    ...
    public EventsErrorsSummaryByHostByError(EventsErrorsSummaryByHostByError value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final EventsErrorsSummaryByHostByError other = (EventsErrorsSummaryByHostByError) obj;
        if (this.host == null) {
            if (other.host != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("EventsErrorsSummaryByHostByError (");
