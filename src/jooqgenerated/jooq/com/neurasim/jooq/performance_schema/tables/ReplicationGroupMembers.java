...
import com.neurasim.jooq.performance_schema.tables.records.ReplicationGroupMembersRecord;
...
public class ReplicationGroupMembers extends TableImpl<ReplicationGroupMembersRecord> {
     ...
     */
    public final TableField<ReplicationGroupMembersRecord, String> MEMBER_COMMUNICATION_STACK = createField(DSL.name("MEMBER_COMMUNICATION_STACK"), SQLDataType.CHAR(64).nullable(false), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function8<? super String, ? super String, ? super String, ? super Integer, ? super String, ? super String, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function8<? super String, ? super String, ? super String, ? super Integer, ? super String, ? super String, ? super String, ? super String, ? extends U> from) {
