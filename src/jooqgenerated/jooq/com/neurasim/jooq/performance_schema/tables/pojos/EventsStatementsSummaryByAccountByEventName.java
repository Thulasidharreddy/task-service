...
public class EventsStatementsSummaryByAccountByEventName implements Serializable {
    ...
    public EventsStatementsSummaryByAccountByEventName(EventsStatementsSummaryByAccountByEventName value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final EventsStatementsSummaryByAccountByEventName other = (EventsStatementsSummaryByAccountByEventName) obj;
        if (this.user == null) {
            if (other.user != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("EventsStatementsSummaryByAccountByEventName (");
