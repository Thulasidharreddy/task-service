...
public class EventsWaitsSummaryByUserByEventName implements Serializable {
    ...
    public EventsWaitsSummaryByUserByEventName(EventsWaitsSummaryByUserByEventName value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final EventsWaitsSummaryByUserByEventName other = (EventsWaitsSummaryByUserByEventName) obj;
        if (this.user == null) {
            if (other.user != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("EventsWaitsSummaryByUserByEventName (");
