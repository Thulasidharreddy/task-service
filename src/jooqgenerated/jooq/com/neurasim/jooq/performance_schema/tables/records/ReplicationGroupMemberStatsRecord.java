...
public class ReplicationGroupMemberStatsRecord extends TableRecordImpl<ReplicationGroupMemberStatsRecord> implements Record13<String, String, String, ULong, ULong, ULong, ULong, String, String, ULong, ULong, ULong, ULong> {
     ...
     */
    public ReplicationGroupMemberStatsRecord setChannelName(String value) {
        set(0, value);
        return this;
    }
     ...
     */
    public ReplicationGroupMemberStatsRecord setViewId(String value) {
        set(1, value);
        return this;
    }
     ...
     */
    public ReplicationGroupMemberStatsRecord setMemberId(String value) {
        set(2, value);
        return this;
    }
     ...
     */
    public ReplicationGroupMemberStatsRecord setCountTransactionsInQueue(ULong value) {
        set(3, value);
        return this;
    }
     ...
     */
    public ReplicationGroupMemberStatsRecord setCountTransactionsChecked(ULong value) {
        set(4, value);
        return this;
    }
     ...
     */
    public ReplicationGroupMemberStatsRecord setCountConflictsDetected(ULong value) {
        set(5, value);
        return this;
    }
     ...
     */
    public ReplicationGroupMemberStatsRecord setCountTransactionsRowsValidating(ULong value) {
        set(6, value);
        return this;
    }
     ...
     */
    public ReplicationGroupMemberStatsRecord setTransactionsCommittedAllMembers(String value) {
        set(7, value);
        return this;
    }
     ...
     */
    public ReplicationGroupMemberStatsRecord setLastConflictFreeTransaction(String value) {
        set(8, value);
        return this;
    }
     ...
     */
    public ReplicationGroupMemberStatsRecord setCountTransactionsRemoteInApplierQueue(ULong value) {
        set(9, value);
        return this;
    }
     ...
     */
    public ReplicationGroupMemberStatsRecord setCountTransactionsRemoteApplied(ULong value) {
        set(10, value);
        return this;
    }
     ...
     */
    public ReplicationGroupMemberStatsRecord setCountTransactionsLocalProposed(ULong value) {
        set(11, value);
        return this;
    }
     ...
     */
    public ReplicationGroupMemberStatsRecord setCountTransactionsLocalRollback(ULong value) {
        set(12, value);
        return this;
    }
     ...
     * Create a detached, initialised ReplicationGroupMemberStatsRecord
     */
    public ReplicationGroupMemberStatsRecord(com.neurasim.jooq.performance_schema.tables.pojos.ReplicationGroupMemberStats value) {
        super(ReplicationGroupMemberStats.REPLICATION_GROUP_MEMBER_STATS);
        ...
        if (value != null) {
            ...
            setCountTransactionsInQueue(value.getCountTransactionsInQueue());
            setCountTransactionsChecked(value.getCountTransactionsChecked());
            setCountConflictsDetected(value.getCountConflictsDetected());
            setCountTransactionsRowsValidating(value.getCountTransactionsRowsValidating());
            setTransactionsCommittedAllMembers(value.getTransactionsCommittedAllMembers());
            setLastConflictFreeTransaction(value.getLastConflictFreeTransaction());
            setCountTransactionsRemoteInApplierQueue(value.getCountTransactionsRemoteInApplierQueue());
            setCountTransactionsRemoteApplied(value.getCountTransactionsRemoteApplied());
            setCountTransactionsLocalProposed(value.getCountTransactionsLocalProposed());
            setCountTransactionsLocalRollback(value.getCountTransactionsLocalRollback());
        }
    }
}
