...
public class ReplicationApplierConfigurationRecord extends UpdatableRecordImpl<ReplicationApplierConfigurationRecord> implements Record7<String, Integer, String, ReplicationApplierConfigurationRequireRowFormat, ReplicationApplierConfigurationRequireTablePrimaryKeyCheck, ReplicationApplierConfigurationAssignGtidsToAnonymousTransactionsType, String> {
     ...
     */
    public ReplicationApplierConfigurationRecord setChannelName(String value) {
        set(0, value);
        return this;
    }
     ...
     */
    public ReplicationApplierConfigurationRecord setDesiredDelay(Integer value) {
        set(1, value);
        return this;
    }
     ...
     */
    public ReplicationApplierConfigurationRecord setPrivilegeChecksUser(String value) {
        set(2, value);
        return this;
    }
     ...
     */
    public ReplicationApplierConfigurationRecord setRequireRowFormat(ReplicationApplierConfigurationRequireRowFormat value) {
        set(3, value);
        return this;
    }
     ...
     */
    public ReplicationApplierConfigurationRecord setRequireTablePrimaryKeyCheck(ReplicationApplierConfigurationRequireTablePrimaryKeyCheck value) {
        set(4, value);
        return this;
    }
     ...
     */
    public ReplicationApplierConfigurationRecord setAssignGtidsToAnonymousTransactionsType(ReplicationApplierConfigurationAssignGtidsToAnonymousTransactionsType value) {
        set(5, value);
        return this;
    }
     ...
     */
    public ReplicationApplierConfigurationRecord setAssignGtidsToAnonymousTransactionsValue(String value) {
        set(6, value);
        return this;
    }
     ...
     * Create a detached, initialised ReplicationApplierConfigurationRecord
     */
    public ReplicationApplierConfigurationRecord(com.neurasim.jooq.performance_schema.tables.pojos.ReplicationApplierConfiguration value) {
        super(ReplicationApplierConfiguration.REPLICATION_APPLIER_CONFIGURATION);

        if (value != null) {
            setChannelName(value.getChannelName());
            setDesiredDelay(value.getDesiredDelay());
            setPrivilegeChecksUser(value.getPrivilegeChecksUser());
