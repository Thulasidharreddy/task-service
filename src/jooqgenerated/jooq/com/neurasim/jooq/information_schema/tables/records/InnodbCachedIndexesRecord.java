...
public class InnodbCachedIndexesRecord extends TableRecordImpl<InnodbCachedIndexesRecord> implements Record3<UInteger, ULong, ULong> {
     ...
     */
    public InnodbCachedIndexesRecord setSpaceId(UInteger value) {
        set(0, value);
        return this;
    }
     ...
     */
    public InnodbCachedIndexesRecord setIndexId(ULong value) {
        set(1, value);
        return this;
    }
     ...
     */
    public InnodbCachedIndexesRecord setNCachedPages(ULong value) {
        set(2, value);
        return this;
    }
     ...
     * Create a detached, initialised InnodbCachedIndexesRecord
     */
    public InnodbCachedIndexesRecord(com.neurasim.jooq.information_schema.tables.pojos.InnodbCachedIndexes value) {
        super(InnodbCachedIndexes.INNODB_CACHED_INDEXES);

        if (value != null) {
            setSpaceId(value.getSpaceId());
            setIndexId(value.getIndexId());
            setNCachedPages(value.getNCachedPages());
        }
    }
}
