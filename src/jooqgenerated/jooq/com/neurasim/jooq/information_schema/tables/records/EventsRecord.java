...
public class EventsRecord extends TableRecordImpl<EventsRecord> {
     ...
     */
    public EventsRecord setIntervalField(EventsIntervalField value) {
        set(10, value);
        return this;
    }
     ...
     */
    public EventsRecord setOriginator(UInteger value) {
        set(20, value);
        return this;
    }
     ...
     * Create a detached, initialised EventsRecord
     */
    public EventsRecord(com.neurasim.jooq.information_schema.tables.pojos.Events value) {
        super(Events.EVENTS);
