...
public class InnodbBufferPage implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final InnodbBufferPage other = (InnodbBufferPage) obj;
        if (this.poolId == null) {
        ...
        if (this.pageState == null) {
            if (other.pageState != null)
                return false;
        }
        else if (!this.pageState.equals(other.pageState))
            return false;
        if (this.ioFix == null) {
            if (other.ioFix != null)
                return false;
        ...
        if (this.isStale == null) {
            if (other.isStale != null)
                return false;
        }
        else if (!this.isStale.equals(other.isStale))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.pageState == null) ? 0 : this.pageState.hashCode());
        ...
        result = prime * result + ((this.isStale == null) ? 0 : this.isStale.hashCode());
        return result;
    }
