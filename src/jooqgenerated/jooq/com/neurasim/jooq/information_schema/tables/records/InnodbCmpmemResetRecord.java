...
public class InnodbCmpmemResetRecord extends TableRecordImpl<InnodbCmpmemResetRecord> implements Record6<Integer, Integer, Integer, Integer, Long, Integer> {
     ...
     */
    public InnodbCmpmemResetRecord setPageSize(Integer value) {
        set(0, value);
        return this;
    }
     ...
     */
    public InnodbCmpmemResetRecord setBufferPoolInstance(Integer value) {
        set(1, value);
        return this;
    }
     ...
     */
    public InnodbCmpmemResetRecord setPagesUsed(Integer value) {
        set(2, value);
        return this;
    }
     ...
     */
    public InnodbCmpmemResetRecord setPagesFree(Integer value) {
        set(3, value);
        return this;
    }
     ...
     */
    public InnodbCmpmemResetRecord setRelocationOps(Long value) {
        set(4, value);
        return this;
    }
     ...
     */
    public InnodbCmpmemResetRecord setRelocationTime(Integer value) {
        set(5, value);
        return this;
    }
     ...
     * Create a detached, initialised InnodbCmpmemResetRecord
     */
    public InnodbCmpmemResetRecord(com.neurasim.jooq.information_schema.tables.pojos.InnodbCmpmemReset value) {
        super(InnodbCmpmemReset.INNODB_CMPMEM_RESET);

        if (value != null) {
            setPageSize(value.getPageSize());
            setBufferPoolInstance(value.getBufferPoolInstance());
            setPagesUsed(value.getPagesUsed());
            setPagesFree(value.getPagesFree());
            setRelocationOps(value.getRelocationOps());
            setRelocationTime(value.getRelocationTime());
        }
    }
}
