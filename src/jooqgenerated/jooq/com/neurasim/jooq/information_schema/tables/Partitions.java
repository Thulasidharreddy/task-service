...
import com.neurasim.jooq.information_schema.tables.records.PartitionsRecord;
...
public class Partitions extends TableImpl<PartitionsRecord> {
    ...
    /**
     * The column <code>information_schema.PARTITIONS.SECONDARY_LOAD</code>.
     */
    public final TableField<PartitionsRecord, String> SECONDARY_LOAD = createField(DSL.name("SECONDARY_LOAD"), SQLDataType.VARCHAR(1), this, "");
