...
import com.neurasim.jooq.information_schema.tables.records.CollationsRecord;
...
public class Collations extends TableImpl<CollationsRecord> {
     ...
     */
    public final TableField<CollationsRecord, CollationsPadAttribute> PAD_ATTRIBUTE = createField(DSL.name("PAD_ATTRIBUTE"), SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(com.neurasim.jooq.information_schema.enums.CollationsPadAttribute.class), this, "");
