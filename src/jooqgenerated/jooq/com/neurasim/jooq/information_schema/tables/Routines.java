...
import com.neurasim.jooq.information_schema.tables.records.RoutinesRecord;
...
public class Routines extends TableImpl<RoutinesRecord> {
     ...
     */
    public final TableField<RoutinesRecord, RoutinesRoutineType> ROUTINE_TYPE = createField(DSL.name("ROUTINE_TYPE"), SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(com.neurasim.jooq.information_schema.enums.RoutinesRoutineType.class), this, "");
     ...
     */
    public final TableField<RoutinesRecord, byte[]> EXTERNAL_NAME = createField(DSL.name("EXTERNAL_NAME"), SQLDataType.VARBINARY, this, "");
     ...
     */
    public final TableField<RoutinesRecord, RoutinesSqlDataAccess> SQL_DATA_ACCESS = createField(DSL.name("SQL_DATA_ACCESS"), SQLDataType.VARCHAR(17).nullable(false).asEnumDataType(com.neurasim.jooq.information_schema.enums.RoutinesSqlDataAccess.class), this, "");

    /**
     * The column <code>information_schema.ROUTINES.SQL_PATH</code>.
     */
    public final TableField<RoutinesRecord, byte[]> SQL_PATH = createField(DSL.name("SQL_PATH"), SQLDataType.VARBINARY, this, "");

    /**
     * The column <code>information_schema.ROUTINES.SECURITY_TYPE</code>.
     */
    public final TableField<RoutinesRecord, RoutinesSecurityType> SECURITY_TYPE = createField(DSL.name("SECURITY_TYPE"), SQLDataType.VARCHAR(7).nullable(false).asEnumDataType(com.neurasim.jooq.information_schema.enums.RoutinesSecurityType.class), this, "");
