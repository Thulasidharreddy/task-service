...
public class EnginesRecord extends TableRecordImpl<EnginesRecord> implements Record6<String, String, String, String, String, String> {
     ...
     */
    public EnginesRecord setEngine(String value) {
        set(0, value);
        return this;
    }
     ...
     */
    public EnginesRecord setSupport(String value) {
        set(1, value);
        return this;
    }
     ...
     */
    public EnginesRecord setComment(String value) {
        set(2, value);
        return this;
    }
     ...
     */
    public EnginesRecord setTransactions(String value) {
        set(3, value);
        return this;
    }
     ...
     */
    public EnginesRecord setXa(String value) {
        set(4, value);
        return this;
    }
     ...
     */
    public EnginesRecord setSavepoints(String value) {
        set(5, value);
        return this;
    }
     ...
     * Create a detached, initialised EnginesRecord
     */
    public EnginesRecord(com.neurasim.jooq.information_schema.tables.pojos.Engines value) {
        super(Engines.ENGINES);

        if (value != null) {
            setEngine(value.getEngine());
            setSupport(value.getSupport());
            setComment(value.getComment());
            setTransactions(value.getTransactions());
            setXa(value.getXa());
            setSavepoints(value.getSavepoints());
        }
    }
}
