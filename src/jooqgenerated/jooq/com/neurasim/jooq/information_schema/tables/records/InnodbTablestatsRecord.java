...
public class InnodbTablestatsRecord extends TableRecordImpl<InnodbTablestatsRecord> implements Record9<ULong, String, String, ULong, ULong, ULong, ULong, ULong, Integer> {
     ...
     */
    public InnodbTablestatsRecord setTableId(ULong value) {
        set(0, value);
        return this;
    }
     ...
     */
    public InnodbTablestatsRecord setName(String value) {
        set(1, value);
        return this;
    }
     ...
     */
    public InnodbTablestatsRecord setStatsInitialized(String value) {
        set(2, value);
        return this;
    }
     ...
     */
    public InnodbTablestatsRecord setNumRows(ULong value) {
        set(3, value);
        return this;
    }
     ...
     */
    public InnodbTablestatsRecord setClustIndexSize(ULong value) {
        set(4, value);
        return this;
    }
     ...
     */
    public InnodbTablestatsRecord setOtherIndexSize(ULong value) {
        set(5, value);
        return this;
    }
     ...
     */
    public InnodbTablestatsRecord setModifiedCounter(ULong value) {
        set(6, value);
        return this;
    }
     ...
     */
    public InnodbTablestatsRecord setAutoinc(ULong value) {
        set(7, value);
        return this;
    }
     ...
     */
    public InnodbTablestatsRecord setRefCount(Integer value) {
        set(8, value);
        return this;
    }
     ...
     * Create a detached, initialised InnodbTablestatsRecord
     */
    public InnodbTablestatsRecord(com.neurasim.jooq.information_schema.tables.pojos.InnodbTablestats value) {
        super(InnodbTablestats.INNODB_TABLESTATS);

        if (value != null) {
            setTableId(value.getTableId());
            setName(value.getName());
            setStatsInitialized(value.getStatsInitialized());
            setNumRows(value.getNumRows());
            setClustIndexSize(value.getClustIndexSize());
            setOtherIndexSize(value.getOtherIndexSize());
            setModifiedCounter(value.getModifiedCounter());
            setAutoinc(value.getAutoinc());
