...
public class InnodbTrx implements Serializable {
    ...
    private final ULong trxScheduleWeight;
    ...
    public InnodbTrx(InnodbTrx value) {
        ...
        this.trxScheduleWeight = value.trxScheduleWeight;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.trxLastForeignKeyError == null) {
            ...
            return false;
        if (this.trxAdaptiveHashLatched == null) {
            if (other.trxAdaptiveHashLatched != null)
                return false;
        }
        else if (!this.trxAdaptiveHashLatched.equals(other.trxAdaptiveHashLatched))
            return false;
        if (this.trxAdaptiveHashTimeout == null) {
            if (other.trxAdaptiveHashTimeout != null)
                return false;
        }
        else if (!this.trxAdaptiveHashTimeout.equals(other.trxAdaptiveHashTimeout))
            return false;
        ...
        if (this.trxAutocommitNonLocking == null) {
            ...
            return false;
        if (this.trxScheduleWeight == null) {
            if (other.trxScheduleWeight != null)
                return false;
        }
        else if (!this.trxScheduleWeight.equals(other.trxScheduleWeight))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.trxAdaptiveHashLatched == null) ? 0 : this.trxAdaptiveHashLatched.hashCode());
        result = prime * result + ((this.trxAdaptiveHashTimeout == null) ? 0 : this.trxAdaptiveHashTimeout.hashCode());
        ...
        result = prime * result + ((this.trxScheduleWeight == null) ? 0 : this.trxScheduleWeight.hashCode());
        return result;
    }
