...
public class InnodbForeignCols implements Serializable {
    ...
    public InnodbForeignCols(InnodbForeignCols value) {
        this.id = value.id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final InnodbForeignCols other = (InnodbForeignCols) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("InnodbForeignCols (");
