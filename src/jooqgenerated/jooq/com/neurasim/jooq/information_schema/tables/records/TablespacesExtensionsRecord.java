...
public class TablespacesExtensionsRecord extends TableRecordImpl<TablespacesExtensionsRecord> implements Record2<String, JSON> {
     ...
     */
    public TablespacesExtensionsRecord setTablespaceName(String value) {
        set(0, value);
        return this;
    }
     ...
     */
    public TablespacesExtensionsRecord setEngineAttribute(JSON value) {
        set(1, value);
        return this;
    }
     ...
     * Create a detached, initialised TablespacesExtensionsRecord
     */
    public TablespacesExtensionsRecord(com.neurasim.jooq.information_schema.tables.pojos.TablespacesExtensions value) {
        super(TablespacesExtensions.TABLESPACES_EXTENSIONS);
