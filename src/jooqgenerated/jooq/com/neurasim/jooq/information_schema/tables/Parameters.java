...
import com.neurasim.jooq.information_schema.tables.records.ParametersRecord;
...
public class Parameters extends TableImpl<ParametersRecord> {
     ...
     */
    public final TableField<ParametersRecord, ParametersRoutineType> ROUTINE_TYPE = createField(DSL.name("ROUTINE_TYPE"), SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(com.neurasim.jooq.information_schema.enums.ParametersRoutineType.class), this, "");
