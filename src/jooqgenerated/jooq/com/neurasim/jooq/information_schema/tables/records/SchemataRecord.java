...
public class SchemataRecord extends TableRecordImpl<SchemataRecord> implements Record6<String, String, String, String, byte[], SchemataDefaultEncryption> {
     ...
     */
    public SchemataRecord setSqlPath(byte[] value) {
        set(4, value);
        return this;
    }
     ...
     */
    public SchemataRecord setDefaultEncryption(SchemataDefaultEncryption value) {
        set(5, value);
        return this;
    }
     ...
     * Create a detached, initialised SchemataRecord
     */
    public SchemataRecord(com.neurasim.jooq.information_schema.tables.pojos.Schemata value) {
        super(Schemata.SCHEMATA);
        ...
        if (value != null) {
            ...
            setDefaultEncryption(value.getDefaultEncryption());
        }
    }
}
