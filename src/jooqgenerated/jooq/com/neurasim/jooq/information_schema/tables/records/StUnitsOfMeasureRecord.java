...
public class StUnitsOfMeasureRecord extends TableRecordImpl<StUnitsOfMeasureRecord> implements Record4<String, String, Double, String> {
     ...
     */
    public StUnitsOfMeasureRecord setUnitName(String value) {
        set(0, value);
        return this;
    }
     ...
     */
    public StUnitsOfMeasureRecord setUnitType(String value) {
        set(1, value);
        return this;
    }
     ...
     */
    public StUnitsOfMeasureRecord setConversionFactor(Double value) {
        set(2, value);
        return this;
    }
     ...
     */
    public StUnitsOfMeasureRecord setDescription(String value) {
        set(3, value);
        return this;
    }
     ...
     * Create a detached, initialised StUnitsOfMeasureRecord
     */
    public StUnitsOfMeasureRecord(com.neurasim.jooq.information_schema.tables.pojos.StUnitsOfMeasure value) {
        super(StUnitsOfMeasure.ST_UNITS_OF_MEASURE);

        if (value != null) {
            setUnitName(value.getUnitName());
            setUnitType(value.getUnitType());
            setConversionFactor(value.getConversionFactor());
