...
import com.neurasim.jooq.information_schema.tables.records.TablesRecord;
...
public class Tables extends TableImpl<TablesRecord> {
     ...
     */
    public final TableField<TablesRecord, TablesTableType> TABLE_TYPE = createField(DSL.name("TABLE_TYPE"), SQLDataType.VARCHAR(11).nullable(false).asEnumDataType(com.neurasim.jooq.information_schema.enums.TablesTableType.class), this, "");
     ...
     */
    public final TableField<TablesRecord, TablesRowFormat> ROW_FORMAT = createField(DSL.name("ROW_FORMAT"), SQLDataType.VARCHAR(10).asEnumDataType(com.neurasim.jooq.information_schema.enums.TablesRowFormat.class), this, "");
