...
public class Statistics implements Serializable {
    ...
    private final Integer nonUnique;
    private final String indexSchema;
    private final String indexName;
    private final UInteger seqInIndex;
    ...
    public boolean equals(Object obj) {
        ...
        else if (!Arrays.equals(this.packed, other.packed))
            return false;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.packed == null) ? 0 : Arrays.hashCode(this.packed));
