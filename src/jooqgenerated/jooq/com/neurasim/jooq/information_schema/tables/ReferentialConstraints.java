...
import com.neurasim.jooq.information_schema.tables.records.ReferentialConstraintsRecord;
...
public class ReferentialConstraints extends TableImpl<ReferentialConstraintsRecord> {
     ...
     */
    public final TableField<ReferentialConstraintsRecord, ReferentialConstraintsMatchOption> MATCH_OPTION = createField(DSL.name("MATCH_OPTION"), SQLDataType.VARCHAR(7).nullable(false).asEnumDataType(com.neurasim.jooq.information_schema.enums.ReferentialConstraintsMatchOption.class), this, "");

    /**
     * The column
     * <code>information_schema.REFERENTIAL_CONSTRAINTS.UPDATE_RULE</code>.
     */
    public final TableField<ReferentialConstraintsRecord, ReferentialConstraintsUpdateRule> UPDATE_RULE = createField(DSL.name("UPDATE_RULE"), SQLDataType.VARCHAR(11).nullable(false).asEnumDataType(com.neurasim.jooq.information_schema.enums.ReferentialConstraintsUpdateRule.class), this, "");

    /**
     * The column
     * <code>information_schema.REFERENTIAL_CONSTRAINTS.DELETE_RULE</code>.
     */
    public final TableField<ReferentialConstraintsRecord, ReferentialConstraintsDeleteRule> DELETE_RULE = createField(DSL.name("DELETE_RULE"), SQLDataType.VARCHAR(11).nullable(false).asEnumDataType(com.neurasim.jooq.information_schema.enums.ReferentialConstraintsDeleteRule.class), this, "");
