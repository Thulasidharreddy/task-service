...
import com.neurasim.jooq.information_schema.tables.records.SchemataRecord;
...
public class Schemata extends TableImpl<SchemataRecord> {
     ...
     */
    public final TableField<SchemataRecord, byte[]> SQL_PATH = createField(DSL.name("SQL_PATH"), SQLDataType.VARBINARY, this, "");

    /**
     * The column <code>information_schema.SCHEMATA.DEFAULT_ENCRYPTION</code>.
     */
    public final TableField<SchemataRecord, SchemataDefaultEncryption> DEFAULT_ENCRYPTION = createField(DSL.name("DEFAULT_ENCRYPTION"), SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.neurasim.jooq.information_schema.enums.SchemataDefaultEncryption.class), this, "");
