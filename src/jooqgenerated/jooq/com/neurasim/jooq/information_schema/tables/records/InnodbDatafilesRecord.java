...
public class InnodbDatafilesRecord extends TableRecordImpl<InnodbDatafilesRecord> implements Record2<byte[], String> {
     ...
     */
    public InnodbDatafilesRecord setSpace(byte[] value) {
        set(0, value);
        return this;
    }
     ...
     */
    public InnodbDatafilesRecord setPath(String value) {
        set(1, value);
        return this;
    }
     ...
     * Create a detached, initialised InnodbDatafilesRecord
     */
    public InnodbDatafilesRecord(com.neurasim.jooq.information_schema.tables.pojos.InnodbDatafiles value) {
        super(InnodbDatafiles.INNODB_DATAFILES);
