...
public class ColumnStatisticsRecord extends TableRecordImpl<ColumnStatisticsRecord> implements Record4<String, String, String, JSON> {
     ...
     */
    public ColumnStatisticsRecord setSchemaName(String value) {
        set(0, value);
        return this;
    }
     ...
     */
    public ColumnStatisticsRecord setTableName(String value) {
        set(1, value);
        return this;
    }
     ...
     */
    public ColumnStatisticsRecord setColumnName(String value) {
        set(2, value);
        return this;
    }
     ...
     */
    public ColumnStatisticsRecord setHistogram(JSON value) {
        set(3, value);
        return this;
    }
     ...
     * Create a detached, initialised ColumnStatisticsRecord
     */
    public ColumnStatisticsRecord(com.neurasim.jooq.information_schema.tables.pojos.ColumnStatistics value) {
        super(ColumnStatistics.COLUMN_STATISTICS);
        ...
        if (value != null) {
            ...
            setHistogram(value.getHistogram());
        }
    }
}
