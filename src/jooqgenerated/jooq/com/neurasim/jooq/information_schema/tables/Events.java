...
import com.neurasim.jooq.information_schema.tables.records.EventsRecord;
...
public class Events extends TableImpl<EventsRecord> {
     ...
     */
    public final TableField<EventsRecord, EventsIntervalField> INTERVAL_FIELD = createField(DSL.name("INTERVAL_FIELD"), SQLDataType.VARCHAR(18).asEnumDataType(com.neurasim.jooq.information_schema.enums.EventsIntervalField.class), this, "");
