...
import com.neurasim.jooq.information_schema.tables.records.ViewsRecord;
...
public class Views extends TableImpl<ViewsRecord> {
     ...
     */
    public final TableField<ViewsRecord, ViewsCheckOption> CHECK_OPTION = createField(DSL.name("CHECK_OPTION"), SQLDataType.VARCHAR(8).asEnumDataType(com.neurasim.jooq.information_schema.enums.ViewsCheckOption.class), this, "");

    /**
     * The column <code>information_schema.VIEWS.IS_UPDATABLE</code>.
     */
    public final TableField<ViewsRecord, ViewsIsUpdatable> IS_UPDATABLE = createField(DSL.name("IS_UPDATABLE"), SQLDataType.VARCHAR(3).asEnumDataType(com.neurasim.jooq.information_schema.enums.ViewsIsUpdatable.class), this, "");
